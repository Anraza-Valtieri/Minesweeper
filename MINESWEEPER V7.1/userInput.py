...
class TextInput:
    ...
    def __init__(self, font_family = "",
        ...
        self.askPlayerName = "Input your name: "
        ...
        for event in events:
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pl.K_BACKSPACE: # FIXME: Delete at beginning of line?
                    ...
                    self.input_string = self.input_string[:min(self.cursor_position + 1, 11)] + \
                                        event.unicode + \
                                        self.input_string[self.cursor_position:]
                    self.cursor_position = min(self.cursor_position + 1, 11)
