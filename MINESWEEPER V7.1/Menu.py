...
def game_intro():
    ...
    while intro is True:
        ...
        if Misc.EZ_SENSOR is True:
            Misc.button("EZ SENSOR ON", 0, Misc.display_height - 20, Misc.display_width, 20, Misc.PINK, Misc.PINK, "S")
        else:
            Misc.button("EZ SENSOR OFF", 0, Misc.display_height-20, Misc.display_width, 20, Misc.GREY, Misc.GREY, "S")
